...
export const QUERY_TEMPLATES: readonly Completion[] = [
  {
    ...
    apply: "errors by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "latency duration_ms every 1m",
    apply: "latency duration_ms every 1m",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "rate per 1m by service",
    apply: "rate per 1m by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "proportion status>=500 AS error_rate by service",
    apply: "proportion status>=500 AS error_rate by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "impact by service",
    apply: "impact by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "baseline error_rate window=12 by service",
    apply: "baseline error_rate window=12 by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "changes version by service",
    apply: "changes version by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "exemplars 3 by service",
    apply: "exemplars 3 by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "percentiles duration_ms by service",
    apply: "percentiles duration_ms by service",
    type: "text",
    detail: "shortcut",
  },
  {
    label: "slowest 10 by duration_ms",
    apply: "slowest 10 by duration_ms",
    type: "text",
    detail: "shortcut",
  },
  {
    ...
    apply: "status>=500",
    type: "text",
    detail: "free-hand search",
  },
  {
    label: '"connection reset"',
    apply: '"connection reset"',
    type: "text",
    detail: "phrase search",
  },
];
...
export const REGEX_TEMPLATES: readonly Completion[] = [
  ...
  {
    label: '"timeout|timed out"',
    apply: '"timeout|timed out"',
    type: "text",
    detail: "linear regex",
  },
  {
