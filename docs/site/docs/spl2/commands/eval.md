...
See [Eval Functions](/docs/spl2/functions/eval-functions) for the complete reference.
...
- [where](/docs/spl2/commands/where) -- Filter using expressions
- [stats](/docs/spl2/commands/stats) -- Aggregate with expressions
- [Eval Functions](/docs/spl2/functions/eval-functions) -- Complete function reference
