...
description: Complete reference for SPL2 aggregation functions -- count, sum, avg, percentiles, and more.
---

# Aggregation Functions

Aggregation functions are used in [`stats`](/docs/spl2/commands/stats), [`timechart`](/docs/spl2/commands/timechart), [`eventstats`](/docs/spl2/commands/eventstats), and [`streamstats`](/docs/spl2/commands/streamstats).
