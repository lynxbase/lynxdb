...
description: Complete reference for SPL2 eval functions -- conditionals, string, math, and multivalue.
---

# Eval Functions

Eval functions are used in [`eval`](/docs/spl2/commands/eval) and [`where`](/docs/spl2/commands/where) expressions.
