...
- CLF is identical to the Combined format but without the `referer` and `user_agent` fields. For Combined logs, use [`unpack_combined`](/docs/lynx-flow/commands/unpack-combined).
...
- [unpack_combined](/docs/lynx-flow/commands/unpack-combined) -- Parse Combined Log Format (CLF + referer/user_agent)
