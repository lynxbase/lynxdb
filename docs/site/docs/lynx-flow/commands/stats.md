...
- For running aggregations (maintaining the original event stream), use [`streamstats`](/docs/lynx-flow/commands/streamstats).
- For adding aggregation columns without collapsing rows, use [`eventstats`](/docs/lynx-flow/commands/eventstats).
...
- [eventstats](/docs/lynx-flow/commands/eventstats) -- Add stats without grouping
- [streamstats](/docs/lynx-flow/commands/streamstats) -- Running aggregation
- [Aggregation Functions](/docs/lynx-flow/functions/aggregation-functions) -- Detailed function reference
