...
- The Combined format extends the Common Log Format (CLF) by adding `referer` and `user_agent` fields. For CLF-only logs, use [`unpack_clf`](/docs/lynx-flow/commands/unpack-clf).
...
- [unpack_clf](/docs/lynx-flow/commands/unpack-clf) -- Parse Common Log Format (without referer/user_agent)
- [unpack_nginx_error](/docs/lynx-flow/commands/unpack-nginx-error) -- Parse nginx error logs
- [rex](/docs/lynx-flow/commands/rex) -- Custom regex extraction for non-standard formats
