...
- `bin` is often used as a building block for time-series aggregations. For a simpler syntax, use [`timechart`](/docs/lynx-flow/commands/timechart).

## See Also

- [timechart](/docs/lynx-flow/commands/timechart) -- Time-series aggregation (combines bin + stats)
- [Time Ranges](/docs/lynx-flow/time-ranges) -- Time range syntax
