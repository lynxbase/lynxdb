...
- For standard logfmt (`key=value` with space delimiter and quoted strings), use [`unpack_logfmt`](/docs/lynx-flow/commands/unpack-logfmt) which is purpose-built and faster.
...
- [unpack_logfmt](/docs/lynx-flow/commands/unpack-logfmt) -- Parse standard logfmt format
- [unpack_json](/docs/lynx-flow/commands/unpack-json) -- Parse JSON fields
- [rex](/docs/lynx-flow/commands/rex) -- Custom regex extraction for complex formats
