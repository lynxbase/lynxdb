...
- [json](/docs/lynx-flow/commands/json-cmd) -- Extract JSON fields before unrolling
- [unpack_json](/docs/lynx-flow/commands/unpack-json) -- Full JSON extraction with prefix support
