...
- [unpack_json](/docs/lynx-flow/commands/unpack-json) -- Extract fields from JSON
- [json command](/docs/lynx-flow/commands/json-cmd) -- Quick JSON field extraction
- [json_object function](/docs/lynx-flow/functions/json-functions) -- Build JSON in eval expressions
